...
export default function Nosotres(){
    return (
        ...
        <p className="nosotres-texto">
          ...
          desarrollo web, creative coding, diseño gráfico, fotografía y
          community management, nos unimos <br/> para dar vida a proyectos <br/> dinámicos
