...
const SearchComponent = () => {
  ...
  const [displayAllergen, setdisplayAllergen] = useState(false)
  const [filterFoods, setFilterFoods] = useState(flattened)
  const {showAllergenPopUp, lang, nombre, isOpenPopUp, allergyList} = useContext(DataContext)
            ...
            >
              ...
              <g id="Layer_2" data-name="Layer 2">
                ...
                <rect
                  ...
                  width="1"
                  height="47.3"
                  transform="translate(-9.79 21.01) rotate(-39.8)"
                />
                <path d="M24,0A24,24,0,1,0,48,24,24,24,0,0,0,24,0Zm0,1A23,23,0,1,1,1,24,23,23,0,0,1,24,1Z" />
              </g>
            </svg>
